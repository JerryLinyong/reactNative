    ...
    return (
      <View style={styles.container}>
        <WingBlank style={{marginTop:40}}>
          <Button style={{marginTop: 20,backgroundColor:'#ffd600'}} activeStyle={{backgroundColor:'grey'}} onClick={()=> {}}>默认服务器</Button>      
          <Button type='primary' style={{marginTop: 20}} activeStyle={{backgroundColor:'grey'}} onClick={() => {}}>企业服务器</Button>
          <Button style={{marginTop: 20,backgroundColor:'#00e676'}} activeStyle={{backgroundColor:'grey'}} onClick={() => {}}>本地服务器</Button>
